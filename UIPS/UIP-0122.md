...
The `%fast` hints on lines 2, 3, and 7 are compiled into Nock, but also result in labels in the Hoon type. For the `+dec` gate, the core is labeled `/dec/one/vial.100`.
