...
description: Propose a new system for deriving jet registrations and hinting
which requires no stored state in the interpreter.
...
The `%fast` hints on lines 2, 3, and 7 are compiled into Nock, but also result
