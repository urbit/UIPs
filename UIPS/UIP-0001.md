...
While the responsibility of the UIP Editor is to organize and manage the UIP Program, the Core Guild will decide the status of each UIP. 

The Core Guild communicates through a tlon messanger group and have open meetings at a monthly? cadence.

### Members of the core guild (TODO: get this list from core guild)
- ~master-morzod
- ~rovnys-
