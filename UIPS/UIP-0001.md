...
The Core Guild is responsible for judging the soundness of proposed changes to Urbit Core. Urbit Core consists of (but is not limited to):

- [Arvo](https://github.com/urbit/urbit)
- [Vere](https://github.com/urbit/vere)
- [Azimuth](https://github.com/urbit/azimuth)
