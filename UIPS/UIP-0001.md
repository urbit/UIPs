...
The Core Guild is resposible for judging the soundness of proposed changes to Urbit Core. Urbit Core consistest of (but not limited to):
...
- Status *(optional)* - This is a section used to give more information as to the implementation status of each UIP. It is encouraged to link PRs, branches, and kevlin releases in this section. 
